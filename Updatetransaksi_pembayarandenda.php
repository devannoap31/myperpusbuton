...
<head>
    ...
    <title>Edit Pembayaran Denda</title>
    <link rel="stylesheet" href="gaya form.css">
</head>
<body>
    <form name="up_bayar" method="POST" action="saveup_bayartr.php">
    <center>
    <h1>EDIT PEMBAYARAN DENDA</h1>
    <h2>Isi data dengan benar!</h2>
    <table width="40%" border ="5" cellspacing="0" cellpadding="0">
        <tr> 
            <th>kode_pembayarandenda</th>
            <td><input type="number" name="kode_pembayarandenda" min="1" max="100" size="60"></td>
        </tr>
        <tr> 
